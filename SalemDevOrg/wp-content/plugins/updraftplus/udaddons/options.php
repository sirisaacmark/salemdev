		...
		if ($installed || ($have_all && 'all' == $key)) {
			...
			if ($have_all && 'all' != $key) {
				...
				if (isset($unclaimed['status']) && 'reclaimable' == $unclaimed['status']) {
					$blurb ='<p><strong>'.__('Available to claim on this site', 'updraftplus').' - <a href="'.UpdraftPlus::get_current_clean_url().'" onclick="return udm_claim(\''.$key.'\');">'.__('activate it on this site', 'updraftplus').'</a></strong></p>';
				} else {
					$blurb ='<p><strong>'.__('You have an inactive purchase', 'updraftplus').' - <a href="'.UpdraftPlus::get_current_clean_url().'" onclick="return udm_claim(\''.$key.'\');">'.__('activate it on this site', 'updraftplus').'</a></strong></p>';
				}
					$preblurb ="";
			} else {
