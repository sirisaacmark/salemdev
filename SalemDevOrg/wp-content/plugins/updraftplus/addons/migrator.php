...
// echo __('To restore using any of the backup sets below, press the button.', 'updraftplus').' '.
		...
		echo '<div id="updraft_migrate_accordion">';
	...
	private function migrate_widget($backup_history = false) {
		...
		$ret .= '<div style="height:30px; margin-top: 10px; clear:left;">
...
if (!class_exists('UpdraftPlus_Addons_Migrator_RemoteSend')) {
	class UpdraftPlus_Addons_Migrator_RemoteSend extends UpdraftPlus_RemoteSend {
		...
		public function updraft_migrate_after_widget() {
			global $updraftplus_admin;
			?>
			<h3><span class="dashicons dashicons-upload"></span><?php _e('Or, send a backup to another site', 'updraftplus');?></h3>
			...
			<h3><span class="dashicons dashicons-download"></span><?php _e('Or, receive a backup from a remote site', 'updraftplus');?></h3>
			...
			$updraftplus_admin->include_template('wp-admin/settings/temporary-clone.php');
		}
