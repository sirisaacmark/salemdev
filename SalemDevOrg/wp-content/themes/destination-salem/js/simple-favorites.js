/*
 * Customized version of simple-favorites.js from Favorites plugin
 * The only customization is to reload the page when clearing favorites
 */
	...
	plugin.bindEvents = function(){
		...
		$(document).on('click', plugin.clear_buttons, function(e){
			...
			plugin.clearFavorites($(this));
                        //CUSTOMIZATION: Reload the page (need delay or otherwise items are still in itinerary)
