...
<div class="mec-wrap <?php echo $event_colorskin . $colorful_class; ?>">
    <div class="mec-event-grid-clean">
        ...
        <?php if($this->style == 'modern'): ?>
            ...
            <div class="mec-event-image"><a class="mec-color-hover" data-event-id="<?php echo $event->data->ID; ?>" href="<?php echo $this->main->get_event_date_permalink($event->data->permalink, $event->date['start']['date']); ?>"><?php echo $event->data->thumbnails['medium']; ?></a></div>
            ...
            <div class="mec-event-footer mec-color">
                <a class="mec-booking-button chev" data-event-id="<?php echo $event->data->ID; ?>" href="<?php echo $this->main->get_event_date_permalink($event->data->permalink, $event->date['start']['date']); ?>" target="_self"><?php echo (is_array($event->data->tickets) and count($event->data->tickets)) ? $this->main->m('register_button', __('REGISTER', 'mec')) : $this->main->m('view_detail', __('More Info', 'mec')) ; ?> <i class="fa fa-angle-double-right"></i></a>
            </div>
        ...
        <?php elseif($this->style == 'clean'): ?>
                ...
                <?php else: ?>
                    ...
                    <div class="mec-event-month">
                        <?php 
                            ...
                            if($post_slug == 'do' || $post_slug == 'home'):
                                echo $this->main->date_label($event->date['start'], $event->date['end'], $this->date_format_clean_1.' '.$this->date_format_clean_2); 
                            endif;
                        ?>
                            &nbsp;
                        </div>
            ...
            <div class="mec-event-image"><a class="mec-color-hover" data-event-id="<?php echo $event->data->ID; ?>" href="<?php echo $this->main->get_event_date_permalink($event->data->permalink, $event->date['start']['date']); ?>"><?php echo $event->data->thumbnails['medium']; ?></a><?php the_favorites_button($event->data->ID, $site_id); ?></div>
            <div class="mec-event-content">
                <h4 class="mec-event-title"><a class="mec-color-hover" data-event-id="<?php echo $event->data->ID; ?>" href="<?php echo $this->main->get_event_date_permalink($event->data->permalink, $event->date['start']['date']); ?>"><?php echo $event->data->title; ?></a></h4>
        ...
        <?php elseif($this->style == 'novel'): ?>
            ...
            <div class="mec-event-content">
                <div class="mec-event-image">
                    <?php 
                        echo $event->data->thumbnails['thumblist']; 
                    ?>
                </div>
